   ...
   <div class="photos-page">
      ...
      <div class="photos-container">
         ...
         <main>
            ...
            :key="person.id"
            :strId="person.strId">
               <img :src="person.strId"  alt="photos">
            </div>
         </main>
      </div>
   </div>
